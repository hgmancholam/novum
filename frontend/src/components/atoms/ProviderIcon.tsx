 ...
 *
 * Renders the official brand glyph (monochrome via currentColor) inside
 * a small glass pill. Used in `RunRow` (history list) and as a chip in
 * `MetaRow` (run header). Unknown providers fall back to "?".
 *
 * Brand paths come from simple-icons (CC0) and are inlined to avoid an
 * extra dependency.
 */
...
export interface ProviderIconProps {
  /** Provider name from the backend. Unknown names render a fallback glyph. */
  name: string;
...
const BRAND_PATHS: Record<LlmProviderName, string> = {
  github:
  ...
  anthropic:
    "M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6118 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5527h3.7442L10.5363 3.541Zm-.3712 10.2547L8.6122 7.355l2.2911 6.4407Z",
  google:
    "M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 12s5.56 12 12.173 12c3.573 0 6.267-1.173 8.373-3.36 2.16-2.16 2.84-5.213 2.84-7.667 0-.76-.053-1.467-.173-2.053H12.48z",
};

function isProvider(v: string): v is LlmProviderName {
  return v in BRAND_PATHS;
}
