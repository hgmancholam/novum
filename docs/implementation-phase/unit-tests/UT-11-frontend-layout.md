...
| 5 | [StatusBadge.test.tsx](../../../frontend/src/components/molecules/StatusBadge.test.tsx) | `StatusBadge` molecule | `running` → Running/info, each of 7 `StopReason` values maps to the documented label + variant, fallback to Unknown, a11y | T22 |
